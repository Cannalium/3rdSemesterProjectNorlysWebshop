...
namespace WebshopClientWeb.BusinessLogicLayer
{
    ...
    {
        readonly ICartServiceAccess _cartAccess;

        public HttpStatusCode CurrentHttpStatusCode { get; set; }

        public CartDataControl()
        {
            _cartAccess = new CartServiceAccess();
        }
            ...
            else
            {
                ...
                foreach (var cartItem in cartItems)
                {
                    if (cartItem.CartProduct.ProdId == newCartProdItem.CartProduct.ProdId)
                    {
                        ...
                        CartServiceAccess.UpdateCartProd(cartItems, newCartProdItem);
